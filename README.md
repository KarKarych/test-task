...
Альтернативные исходы не включают в себя 400 ошибки, связанные с неправильнм именованием ключей, неправильными значениями и отсутствующими парами ключ-значение в json,
а также не включают 401 и 403 ошибки из-за отсутствия секретного ключа, отсуствия прав на доступ к эндпоинту или из-за неактивированного аккаунта
...
```
Альтернативные исходы:
- 400 - currency_from совпадает с currency_to
- 400 - amount <= 0
- 400 - на счёте недостаточно средств
